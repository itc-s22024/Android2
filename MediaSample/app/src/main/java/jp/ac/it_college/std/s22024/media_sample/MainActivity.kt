package jp.ac.it_college.std.s22024.media_sample
...
import jp.ac.it_college.std.s22024.media_sample.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val mediaFileUri = Uri.parse(
          "android.resource://${packageName}/${R.raw.horagai}"
        )
        mediaPlayer?.apply {
