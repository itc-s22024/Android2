...
import jp.ac.it_college.std.s22024.async_sample.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun receiveWeatherInfo(q: String) {
        ...
        val backgroundReceiver = WeatherIndoBackgroundReceiver(url)
    ...
    private class WeatherIndoBackgroundReceiver(val urlString: String) : Callable<String> {
        @WorkerThread
